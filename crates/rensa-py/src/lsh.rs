...
//! permutations for the `MinHash` signatures, the seed used to generate those signatures, and the
//! number of bands to use for LSH.
...
//!
//! Key methods include:
//! - `new(threshold, num_perm, num_bands, seed)`: Initializes a new LSH index.
